		...
		if (initial_calibration){
			...
			*/
			...
			/*
				Compute motor speed
			*/
			Eigen::Vector4d rotor_speed = control_node.lee_position_controller_.CalculateRotorVelocities(
				orientation_W, position_W, velocity_W, angular_rate_kfly, trajectory_ref,
				control_node.debug_file, logs_control_side);
			// saturate for safety
